...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/loremipsum",
      };
  ...
  const projectUrl = `https://loremipsum.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Muhammad Amrullah</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Muhammad Amrullah — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Muhammad Amrullah`}
        />
        <meta
